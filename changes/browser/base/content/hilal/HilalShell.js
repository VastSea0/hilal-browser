  ...
  const MaterialYouTheme = {
    ...
    isDarkMode() {
      if (document.documentElement.hasAttribute("lwtheme-brighttext")) {
        return document.documentElement.getAttribute("lwtheme-brighttext") === "true";
      }
    ...
    initListeners() {
      ...
      obs.observe(document.documentElement, { attributes: true, attributeFilter: ["lwtheme-brighttext"] });
    },
    ...
    applyTheme(colorInput) {
      ...
      if (isDark) {
        ...
        rootStyle.setProperty("--md-sys-color-primary", `oklch(0.42 ${chroma.toFixed(3)} ${h})`);
        rootStyle.setProperty("--md-sys-color-on-primary", `oklch(0.98 0.005 ${h})`);
        rootStyle.setProperty("--md-sys-color-primary-container", `oklch(0.88 ${(chroma * 0.65).toFixed(3)} ${h})`);
        rootStyle.setProperty("--md-sys-color-on-primary-container", `oklch(0.18 ${(chroma * 0.85).toFixed(3)} ${h})`);

        // Surface tinting (M3 Expressive light tones 98, 96, 93, 89, 85)
        rootStyle.setProperty("--md-sys-color-surface", `oklch(0.98 0.008 ${h})`);
        rootStyle.setProperty("--md-sys-color-surface-dim", `oklch(0.93 0.012 ${h})`);
        rootStyle.setProperty("--md-sys-color-surface-container-lowest", `oklch(1.00 0.000 ${h})`);
        rootStyle.setProperty("--md-sys-color-surface-container-low", `oklch(0.96 0.010 ${h})`);
        rootStyle.setProperty("--md-sys-color-surface-container", `oklch(0.93 0.014 ${h})`);
        rootStyle.setProperty("--md-sys-color-surface-container-high", `oklch(0.89 0.018 ${h})`);
        rootStyle.setProperty("--md-sys-color-surface-container-highest", `oklch(0.85 0.022 ${h})`);

        // Text & outline
        rootStyle.setProperty("--md-sys-color-on-surface", `oklch(0.18 0.015 ${h})`);
        rootStyle.setProperty("--md-sys-color-on-surface-variant", `oklch(0.38 0.022 ${h})`);
        rootStyle.setProperty("--md-sys-color-outline", `oklch(0.52 0.025 ${h})`);
        rootStyle.setProperty("--md-sys-color-outline-variant", `oklch(0.80 0.018 ${h})`);

        // Secondary & Tertiary
        rootStyle.setProperty("--md-sys-color-secondary", `oklch(0.45 0.06 ${h})`);
        rootStyle.setProperty("--md-sys-color-secondary-container", `oklch(0.88 0.04 ${h})`);
      }
    },
  };
  ...
  const HilalShell = {
    ...
    init() {
      ...
      if (typeof Services !== "undefined") {
        try {
          this.tabMode = Services.prefs.getStringPref("hilal.tabs.layoutMode", "vertical");
        } catch (e) {
    ...
    createHeaderShell() {
      ...
      copyBtn.addEventListener("click", (e) => {
        ...
        if (url && url !== "about:blank" && url !== "about:newtab") {
          ...
          copyBtn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"/></svg>';
      ...
      themeBtn.title = "Page Theme & Tone";
      themeBtn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 3c-4.97 0-9 4.03-9 9 0 2.12.74 4.07 1.97 5.61L4.35 19.4c-.39.39-.39 1.02 0 1.41.39.39 1.02.39 1.41 0l1.9-1.9C9.17 19.59 10.54 20 12 20c4.97 0 9-4.03 9-9s-4.03-9-9-9zm0 15c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z"/><circle cx="8.5" cy="10.5" r="1.5"/><circle cx="15.5" cy="10.5" r="1.5"/><circle cx="12" cy="7.5" r="1.5"/></svg>';
      ...
      hNewTabBtn.title = "New Tab (⌘T / Ctrl+T)";
      hNewTabBtn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>';
    ...
    setTabMode(mode, persist = true) {
      ...
      const trafficLights = document.getElementById("hilal-traffic-lights-spacer");
      const topTrafficSlot = document.getElementById("hilal-topbar-traffic-slot");
    ...
    MODE_ICONS: {
      vertical: '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="3"/><line x1="9" y1="3" x2="9" y2="21"/><line x1="5.5" y1="7" x2="6.5" y2="7"/><line x1="5.5" y1="11" x2="6.5" y2="11"/></svg>',
      ...
      horizontal: '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="3"/><line x1="3" y1="8.5" x2="21" y2="8.5"/><line x1="9" y1="3" x2="9" y2="8.5"/><line x1="15" y1="3" x2="15" y2="8.5"/></svg>',
    },
    ...
    updateModeButton() {
      ...
      if (this.tabMode === "vertical") {
        ...
        btn.title = "Tab Layout: Dual Mode (Safari Style: Horizontal & Vertical, Click to switch)";
        btn.innerHTML = this.MODE_ICONS.dual;
      } else {
        btn.title = "Tab Layout: Horizontal Only (Chrome Style, Click to switch)";
    ...
    showModeContextMenu(anchor, event) {
      ...
      if (!menu) {
        ...
        const options = [
          { id: "vertical", label: "Vertical Sidebar Tabs", icon: this.MODE_ICONS.vertical },
          { id: "dual", label: "Dual Tabs (Safari Style)", icon: this.MODE_ICONS.dual },
          { id: "horizontal", label: "Horizontal Tabs (Chrome Style)", icon: this.MODE_ICONS.horizontal },
        ];
        ...
        document.addEventListener("mousedown", (e) => {
          if (menu.style.display !== "none" && !menu.contains(e.target) && !anchor.contains(e.target)) {
            menu.style.display = "none";
          }
        });
      }
    ...
    setupUrlSearchAndSuggestions() {
      ...
      const updateClearBtn = () => {
        if (clearBtn) {
          clearBtn.style.display = (document.activeElement === input && input.value.trim().length > 0) ? "inline-flex" : "none";
        }
      };
      ...
      input.addEventListener("keydown", (e) => {
        if (dropdown.style.display === "flex" && this._suggestions.length > 0) {
          if (e.key === "ArrowDown") {
            e.preventDefault();
            this._selectedSuggestionIndex = (this._selectedSuggestionIndex + 1) % this._suggestions.length;
        ...
        if (e.key === "Enter") {
          e.preventDefault();
          if (this._selectedSuggestionIndex >= 0 && this._suggestions[this._selectedSuggestionIndex]) {
            this.executeSuggestion(this._suggestions[this._selectedSuggestionIndex]);
          } else {
    ...
    async fetchAndRenderSuggestions(query) {
      ...
      if (trimmed) {
        ...
        if ((trimmed.includes(".") && !trimmed.includes(" ")) || trimmed.startsWith("http://") || trimmed.startsWith("https://")) {
          const directUrl = trimmed.startsWith("http") ? trimmed : `https://${trimmed}`;
          items.push({
            type: "url",
            label: directUrl,
            sub: "Visit website",
        ...
        try {
          const webSuggestions = await this.fetchLiveSearchSuggestions(trimmed, this._searchAbortController.signal);
          webSuggestions.forEach((s) => items.push(s));
        } catch (e) {}
      } else {
        // When input is blank, suggest top open tabs
        const tabs = Array.from(window.gBrowser?.tabs || []).filter((t) => !t.hidden).slice(0, 4);
        tabs.forEach((tab) => {
          items.push({
            type: "tab",
            label: tab.label || "Tab",
    ...
    renderSuggestionsDropdown(items) {
      ...
      items.forEach((item, index) => {
        ...
        if (item.type === "search" || item.type === "suggestion") {
          iconDiv.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/></svg>';
        } else if (item.type === "url") {
          iconDiv.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>';
        } else if (item.type === "tab") {
          iconDiv.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14z"/></svg>';
        } else if (item.type === "history") {
          iconDiv.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M13 3a9 9 0 0 0-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42A8.954 8.954 0 0 0 13 21a9 9 0 0 0 0-18zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/></svg>';
        }
        ...
        if (item.type === "tab") {
          ...
          trail.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5 19h14V5H5v14zm10-10l-6 6-1.41-1.41L12.17 9H8V7h8v8h-2v-4.17z"/></svg>';
          row.appendChild(trail);
        }
    ...
    getMatchingOpenTabs(query) {
      ...
      for (const tab of window.gBrowser.tabs) {
        ...
        if (title.toLowerCase().includes(term) || uri.toLowerCase().includes(term)) {
          results.push({
            type: "tab",
            label: title,
            sub: uri,
        ...
        swatch.addEventListener("click", (e) => {
          ...
          if (typeof Services !== "undefined") {
            try {
              ...
              const activeId = Services.prefs.getStringPref("hilal.workspaces.active", workspaces[0]?.id);
      ...
      if (slot && nativePageActions) {
        ...
        if (!nativePageActions._hilalListenerAttached) {
          ...
          nativePageActions.addEventListener("click", (event) => {
            ...
            const btn = event.target.closest(".urlbar-page-action, [role='button'], toolbarbutton");
            if (!btn) return;

            if (btn.id === "star-button-box" || btn.closest("#star-button-box")) {
              event.preventDefault();
              event.stopPropagation();
              if (typeof PlacesCommandHook !== "undefined" && PlacesCommandHook.bookmarkPage) {
                PlacesCommandHook.bookmarkPage();
              } else if (typeof BookmarkingUI !== "undefined" && BookmarkingUI.onStarCommand) {
                BookmarkingUI.onStarCommand(event);
              }
            } else if (btn.id === "reader-mode-button" || btn.closest("#reader-mode-button")) {
              if (isLeftClick && typeof AboutReaderParent !== "undefined") {
                event.preventDefault();
                event.stopPropagation();
                AboutReaderParent.toggleReaderMode(event);
              }
            } else if (btn.id === "urlbar-zoom-button" || btn.closest("#urlbar-zoom-button")) {
              if (isLeftClick && typeof FullZoom !== "undefined") {
                event.preventDefault();
                event.stopPropagation();
                FullZoom.resetFromURLBar();
              }
            } else if (btn.id === "hilal-boosts-button" || btn.closest("#hilal-boosts-button")) {
              event.preventDefault();
              event.stopPropagation();
    ...
    createHorizontalTab(tab) {
      ...
      htab.addEventListener("dragstart", (e) => {
        ...
        e.dataTransfer.setData("text/plain", tab.getAttribute("data-tab-id") || "hilal-htab");
      });
    ...
    openTabContextMenu(tab, triggerEl, event) {
      ...
      if (contextMenu) {
        ...
        if (typeof contextMenu.openPopup === "function") {
          contextMenu.openPopup(triggerEl, "after_start", 0, 0, true, false, event);
        }
      }
    },
    ...
    syncUrl() {
      ...
      const isRealWebPage = currentUri.startsWith("http://") || currentUri.startsWith("https://");
      ...
      if (document.activeElement !== input) {
        ...
        if (copyBtn) {
          copyBtn.style.display = (input.value.trim().length > 0 && isRealWebPage) ? "inline-flex" : "none";
        }
        if (themeBtn) {
          themeBtn.style.display = (input.value.trim().length > 0 && isRealWebPage) ? "inline-flex" : "none";
        }
      } else {
        if (clearBtn) {
      ...
      if (secIcon && window.gBrowser.currentURI) {
        ...
        if (scheme === "https") {
          secIcon.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"/></svg>';
        } else {
          secIcon.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>';
        }
      }
